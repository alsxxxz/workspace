...
public class BoxOfficeUi extends JFrame {
    ...
    private void addEventListener() {
    	...
    	btnSearch.addActionListener((e)->{
    		model.setRowCount(0);
    		comboType.getItemAt(comboType.getSelectedIndex());
    		List<BoxOffice> list = cli.readBoxofficeList(type);
    		for(BoxOffice office: list) {
    			model.addRow(new Object[]{office.rank(), office.movieNm(), office.openDt(), office.audiAcc()});
    		}
