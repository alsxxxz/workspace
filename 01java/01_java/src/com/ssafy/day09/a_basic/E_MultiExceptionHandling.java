...
public class E_MultiExceptionHandling {
    ...
    public static void main(String[] args) {
        // TODO: 다음에서 발생하는 예외를 처리해보자.
         try{ Class.forName("abc.Def"); // ClassNotFoundException
         new FileInputStream("Hello.java"); // FileNotFoundException
         DriverManager.getConnection("Hello"); // SQLException
         
         }catch(ClassNotFoundException  || FileNotFoundExceptione e) {
        	 System.out.println("class가 없다" + e);
//         }catch(FileNotFoundException e) {
//        	 System.out.println("file이 업삳" + e);
